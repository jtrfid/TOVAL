...
public class SetUtils {
	...
	/**
	 * Generates a random subset of <code>set</code>, that contains exactly
	 * <code>maxCount</code> elements.
	 * 
	 * @param <T>
	 *            Type of set elements
	...
	/**
	 * Basic class for representing a powerset (the set of all subsets of a
	 * set).<br>
	...
	public static class PowerSet<T> extends HashMap<Integer, List<HashSet<T>>> {
		 ...
		 * 
		 * @param setSize
		 *            The size (number of elements) of the underlying set
		 */
