...
public class FormatUtils {
	...
	/**
	 * Generator-String used for creating formats for representing non-integers.
	 * <br>
	 ...
	 * It can be parameterized by the desired index and the format itself
	...
	/**
	 * Generator-String used for creating generator-strings for creating formats
	 * with trim-constraints.<br>
	...
	/**
	 * Returns a String representation of the given object using an appropriate
	 * format trimmed to the specified length.
	 * 
	 * @param o
	 *            Object for which a String representation is desired.
	 * @param length
	...
	/**
	 * Extends a given format by additional constraints for trimmed
	 * (length-limited) outputs.<br>
	 * It assumes that the given String is a valid format.
	 * 
	 * @param format
	 *            Format to extend
	 * @param length
	 *            Desired fixed output length for formatted output
