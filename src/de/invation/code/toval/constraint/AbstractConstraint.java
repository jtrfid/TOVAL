...
public abstract class AbstractConstraint<T extends Object> implements DialogObject<AbstractConstraint<T>> {
    ...
    public final void setElement(String element) throws ParameterException {
    ...
    public final void setParameters(T... parameters) throws ParameterException {
    ...
    public boolean equals(Object obj) {
     ...
     @Override
    public void takeoverValues(AbstractConstraint<T> other) throws Exception {
