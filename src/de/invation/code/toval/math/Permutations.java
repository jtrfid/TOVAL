...
/**
 * Permutation Generator. Generates all permutations of an array with a
 * specified length.
 *
...
public abstract class Permutations<T> implements Iterator<T> {
        ...
        /**
         * Initializes the permutation generation mechanism using the specified
         * length, which is interpreted as the number of elements that are
         * permuted.
         *
        ...
        /**
         * This <code>Iterator</code>-implementation does not support the
         * optional <code>remove</code>-operation.
         */
        @Override
        public void remove() {
