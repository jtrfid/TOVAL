...
public class CollectionUtils {
	...
	/**
	 * Returns a format-String that can be used to generate a String representation of a collection
	...
	public static String getFormat(Collection<?> coll, int precision, String valueSeparation, String start, String end) {
